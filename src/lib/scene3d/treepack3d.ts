 ...
 *
 *  RAISED from 0.55, in two steps, the second one on sight. At 0.55 the bake was a 45% crush on the
 *  crown's interior, laid over a leaf map already at 0.171 linear luminance and under a per-instance
 *  tint averaging 0.81: three darkenings compounding on one photograph, for a typical leaf albedo of
 *  0.099 against the 0.15 to 0.20 real foliage sits at, and an interior at 0.073, which is bark.
 *
