...
import { DriverManagerPanel } from '@/components/home/DriverManagerPanel'
  ...
  return (
    <div className="h-full overflow-hidden bg-[#0F1419] text-[#FFFFFF]">
      <div className="max-w-7xl mx-auto h-full px-4 py-4 flex flex-col gap-3 min-h-0">
        ...
        <TeamManagerPanel />
        {/* Driver mode: your strip (teammate head-to-head, championship line + last race, driver-page shortcut). */}
        <DriverManagerPanel />
