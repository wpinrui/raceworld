...
- **Season review + archetype retrospectives** — pays off the preview: how the title was won (wire-to-wire / comeback / decider / clear), who beat or missed their projection, the best of the rest; plus the season's individual stories from an **archetype classifier** (an overachiever dragging a lesser car to podiums, a preseason pick who flopped, a rookie beating a veteran team-mate, a late-career resurgence) and teammate-battle verdicts (one driver routing the other on equal machinery). The classifier tags the season's shapes and frames coverage rather than spawning an article per archetype; wet/safety-car-dependent archetypes are deferred until that data is persisted.
