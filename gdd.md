...
## Funding tier
Funding tier is tracked by the relative performance of the teams in the past five years of the championship by average constructors' championship position. (For the purposes of the first few seasons of the game with no data, the five year window is simply populated assuming that the best paced team to start the season won for the last five years, the second best paced team was second the last five years, and so on.) Note that the number of teams on the grid can change, but Tier 1 always houses 3 teams, Tier 4 always houses 3 teams, and Tiers 2 and 3 house an equal number of remaining teams.
